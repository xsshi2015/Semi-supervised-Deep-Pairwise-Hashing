...
#             if nbsup > 0:
#                 bn= nbsup
#                 Y_prob = F.sigmoid(0.5*torch.matmul(Y_h[cond,:], Y_h[cond,:].permute(1,0)))
...
#                 Y_prob = F.sigmoid(0.5*torch.matmul(out_h1, out_h2.permute(1,0)))
#                 S_prob = F.sigmoid(0.5*torch.matmul(z_h1, z_h2.permute(1,0)))
